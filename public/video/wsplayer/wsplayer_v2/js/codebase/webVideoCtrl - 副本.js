        ...
        var e = function () {
            ...
            window.GetSelectWndInfo = function (e) {
                if (Z()) {
                    ...
                    var t, n = v.loadXML(e);
                    if (0 < re.$XML(n).find("SelectWnd", !0).length)
                        P = parseInt(re.$XML(n).find("SelectWnd").eq(0).text(), 10), null === g && R(), (t = []).push("<RealPlayInfo>"), t.push("<SelectWnd>" + P + "</SelectWnd>"), t.push("</RealPlayInfo>"), p.cbSelWnd && p.cbSelWnd(v.loadXML(t.join("")));
            ...
            var T = function () {
                ...
                L = function (e, t) {
                    var n = "", r = {
                        type: "GET", async: !1, success: function (e) {
                    ...
                    o.I_GetSecurityVersion(e, {
                        success: function (e) {
                            oSecurityCap.iKeyIterateNum = parseInt(re.$XML(e).find("keyIterateNum").eq(0).text(), 10), oSecurityCap.oIrreversibleEncrypt = {
                                bSupport: "true" === re.$XML(e).find("isIrreversible").eq(0).text(), salt: re.$XML(e).find("salt").eq(0).text()
                            },
                ...
                q = function () {
                    var e = "";
                    if (v.browser().msie)
                        e = "<object classid='" + p.szOcxClassId + "' codebase='' standby='Waiting...' id='" + u + "' width='" + h + "' height='" + f + "' align='center' ><param name='wndtype' value='" + p.iWndowType + "'><param name='playmode' value='" + p.iPlayMode + "'><param name='colors' value='" + p.szColorProperty + "'></object>";
                    else
                ...
                X = function (e) {
                    ...
                    return e.oProtocolInc.getPortInfo(e, {
                        ...
                        iRtspPort: s, iHttpPort: o, iDevicePort: i
                    }
                },
                _ = function (e) {
                    var s = -1, o = -1, i = -1;
                    ...
                    return t.oProtocolInc.getNetworkBond(t, {
                        async: !1, success: function (e) {
                            "true" == re.$XML(e).find("enabled").eq(0).text() ? r.push({
                                ipv4: re.$XML(e).find("ipAddress").eq(0).text(), ipv6: re.$XML(e).find("ipv6Address").eq(0).text()
                ...
                N = function () {
                    return "<requestURL></requestURL>", "<statusCode>4</statusCode>", "<statusString>Invalid Operation</statusString>", "<subStatusCode>notSupport</subStatusCode>", "</ResponseStatus>", v.loadXML("<ResponseStatus><requestURL></requestURL><statusCode>4</statusCode><statusString>Invalid Operation</statusString><subStatusCode>notSupport</subStatusCode></ResponseStatus>")
                };
            this.I_SupportNoPlugin = function () {
                ...
                this.I_InsertOBJECTPlugin = function (e) {
                    ...
                    if (Z()) {
                        var t = {
                            szId: e, iType: 1, iWidth: h, iHeight: f, iMaxSplit: 4, iCurrentSplit: p.iWndowType, szBasePath: v.getDirName()
                        },
                            n = p.szColorProperty;
                        if ("" != n) {
                ...
                this.I_GetLocalCfg = function () {
                    ...
                    if (Z())
                        return e;
                    var t = y.HWP_GetLocalConfig(),
                        n = [];
                    return g = v.loadXML(t), n.push("<LocalConfigInfo>"),
            ...
            var F = function (r, s, o, i, a, u, c) {
                var e = {
                    protocol: s, success: null, error: null
                };
                v.extend(e, c), v.extend(e, {
                    success: function (e) {
                        var t,
                            n = new O;
                        n.szIP = r,
                            2 == s ? (n.szHttpProtocol = "https://", n.iHttpsPort = o) : (n.szHttpProtocol = "http://", n.iHttpPort = o),
                            n.iCGIPort = o,
                            n.szDeviceIdentify = r + "_" + o,
                            n.szAuth = i,
                            n.iDeviceProtocol = a,
                            n.oProtocolInc = u,
                            T("使用%s协议登录成功", a),
                            w(n),
                            t = p.bWndFull ? 1 : 0,
                            y.HWP_SetCanFullScreen(t),
                            y.HWP_SetPackageType(p.iPackageType),
                            G(n),
                            I.push(jQuery.extend({}, n)),
            ...
            function O() {
                ...
                this.szIP = "", this.szHostName = "", this.szAuth = "", this.szHttpProtocol = "http://", this.iCGIPort = 80, this.szDeviceIdentify = "", this.iDevicePort = -1, this.iHttpPort = -1, this.iHttpsPort = -1, this.iRtspPort = -1, this.iWSPort = -1, this.iAudioType = 1, this.m_iAudioBitRate = -1, this.m_iAudioSamplingRate = -1, this.iDeviceProtocol = x, this.oProtocolInc = null, this.iAnalogChannelNum = 0, this.szDeviceType = "", this.bVoiceTalk = !1, this.oAuthType = {},
                    this.oStreamCapa = {
                        bObtained: !1, bSupportShttpPlay: !1, bSupportShttpPlayback: !1, bSupportShttpsPlay: !1, bSupportShttpsPlayback: !1, bSupportShttpPlaybackTransCode: !1, bSupportShttpsPlaybackTransCode: !1, iIpChanBase: 1
                    },
                    O.unique = this
            }
            this.getAuthType = function (t, n, e, r, s, o) {
                ...
                this.I_Login = function (r, s, o, i, a, u) {
                    ...
                    if (-1 != this.findDeviceIndexByIP(e))
                        return T("设备已经登录过"), -1;
                    var c = S, l = x;
                    if (M(u.cgi) || (l = x == u.cgi ? (c = S, x) : (c = C, 2)), Z()) if (x == l) {
                        var d = new O;
                ...
                this.I_StartRealPlay = function (e, t) {
                    var n = this.findDeviceIndexByIP(e), r = "", s = "", o = -1, i = 0, a = 0, u = !1, c = {
                        iWndIndex: P, iStreamType: 1, iChannelID: 1, bZeroChannel: !1
                    };
                    if (v.extend(c, t), -1 != n) {
                        E(I[n]);
                        var l = I[n];
                        if (Z()) {
                            ...
                            s = /^(https)(.*)$/.test(d) ? "wss://" : "ws://", M(c.iWSPort) ? l.iWSPort = 7681 : l.iWSPort = c.iWSPort, o = l.iWSPort, a = c.iStreamType, i = c.iChannelID <= l.iAnalogChannelNum ? c.iChannelID : l.oStreamCapa.iIpChanBase + parseInt(c.iChannelID, 10) - l.iAnalogChannelNum - 1, u = !0
                        }
                        else {
                        ...
                        v.extend(c, {
                            urlProtocol: s, cgi: r, iPort: o, iStreamType: a, iChannelID: i
                ...
                this.I_StopRecord = function (e) {
                    ...
                    if (-1 != n) {
                        var r = m[n];
                        if (r.bRecord) if (Z()) v.browser().chrome ? y.JS_StopSave(t.iWndIndex).then(function () {
                ...
                this.I_PTZControl = function (e, t, n) {
                    var r = {
                        iWndIndex: P, iPTZIndex: e, iPTZSpeed: 4
                    };
                ...
                this.I_RecordSearch = function (e, t, n, r, s) {
                    ...
                    if (-1 != o) {
                        var i = I[o], a = {
                            iChannelID: t, szStartTime: n, szEndTime: r, iSearchPos: 0, iStreamType: 1, success: null, error: null
                        };
                ...
                this.I_StartPlayback = function (e, t) {
                    var n = this.findDeviceIndexByIP(e), r = "", s = "", o = -1, i = 1, a = 0, u = v.dateFormat(new Date, "yyyy-MM-dd"), c = {
                        iWndIndex: P, iStreamType: 1, iChannelID: 1, szStartTime: u + " 00:00:00", szEndTime: u + " 23:59:59"
                    };
                    if (v.extend(c, t), -1 != n) {
                        E(I[n]);
                        var l = I[n];
                        if (Z()) {
                            ...
                            var d = location.protocol;
                            s = /^(https)(.*)$/.test(d) ? "wss://" : "ws://", M(c.iWSPort) ? l.iWSPort = 7681 : l.iWSPort = c.iWSPort, o = l.iWSPort, a = c.iStreamType, i = 100 * (i = c.iChannelID <= l.iAnalogChannelNum ? c.iChannelID : l.oStreamCapa.iIpChanBase + parseInt(c.iChannelID, 10) - l.iAnalogChannelNum - 1) + a
                        }
                        else {
                            o = 0 == parseInt(re.$XML(g).find("ProtocolType").eq(0).text(), 10) && l.oStreamCapa.bSupportShttpPlay ? (r = M(c.oTransCodeParam) ? l.oProtocolInc.CGI.startShttpPlayback : l.oProtocolInc.CGI.startTransCodePlayback, s = "http://", a = c.iStreamType - 1, i = c.iChannelID <= l.iAnalogChannelNum ? c.iChannelID : l.oStreamCapa.iIpChanBase + parseInt(c.iChannelID, 10) - l.iAnalogChannelNum - 1, l.bSupportSubStreamPlayback && (i = 100 * i + a), M(c.iPort) ? "https://" == l.szHttpProtocol ? (-1 == l.iHttpPort && (l.iHttpPort = W(l).iHttpPort), l.iHttpPort) : l.iCGIPort : (l.iHttpPort = c.iPort, c.iPort)) : (r = l.oProtocolInc.CGI.startPlayback, s = "rtsp://", a = c.iStreamType, i = 100 * c.iChannelID + a, M(c.iRtspPort) || (l.iRtspPort = c.iRtspPort), -1 == l.iRtspPort && (l.iRtspPort = W(l).iRtspPort), l.iRtspPort)
                        }
                        if (-1 == o)
                            return T("获取端口号失败"), void (t.error && t.error());
                        v.extend(c, {
                            urlProtocol: s, cgi: r, iPort: o, iChannelID: i
                        }), -1 == (n = this.findWndIndexByIndex(c.iWndIndex)) && (Z() ? (c.szStartTime = c.szStartTime.replace(" ", "T") + "Z", c.szEndTime = c.szEndTime.replace(" ", "T") + "Z", l.oProtocolInc.startPlayback(l, c).then(function () {
                            t.success && t.success()
                        },
                            function () {
                                t.error && t.error()
                ...
                this.I_ReversePlayback = function (e, t) {
                    var n = this.findDeviceIndexByIP(e), r = -1, s = "", o = "", i = -1, a = -1, u = 0, c = v.dateFormat(new Date, "yyyy-MM-dd"), l = {
                        iWndIndex: P, iStreamType: 1, iChannelID: 1, szStartTime: c + " 00:00:00", szEndTime: c + " 23:59:59"
                    };
                    if (v.extend(l, t), -1 != n) {
                        E(I[n]);
                        var d = I[n];
                        ...
                        if (-1 == (i = 0 == parseInt(re.$XML(g).find("ProtocolType").eq(0).text(), 10) && d.oStreamCapa.bSupportShttpPlay ? (s = d.oProtocolInc.CGI.startShttpReversePlayback, o = "http://", u = l.iStreamType - 1, a = 100 * (a = l.iChannelID <= d.iAnalogChannelNum ? l.iChannelID : d.oStreamCapa.iIpChanBase + parseInt(l.iChannelID, 10) - d.iAnalogChannelNum - 1) + u, M(l.iPort) ? "https://" == d.szHttpProtocol ? (-1 == d.iHttpPort && (d.iHttpPort = W(d).iHttpPort), d.iHttpPort) : d.iCGIPort : (d.iHttpPort = l.iPort, l.iPort)) : (s = d.oProtocolInc.CGI.startPlayback, o = "rtsp://", u = l.iStreamType, a = 100 * l.iChannelID + u, M(l.iRtspPort) || (d.iRtspPort = l.iRtspPort), -1 == d.iRtspPort && (d.iRtspPort = W(d).iRtspPort), d.iRtspPort)))
                            return T("获取端口号失败"), r;
                        v.extend(l, {
                            urlProtocol: o, cgi: s, iPort: i, iChannelID: a
                ...
                this.I_Frame = function (e) {
                    ...
                    if (-1 != n) {
                        ...
                        if (2 == s || 4 == s) if (Z()) y.JS_FrameForward(t.iWndIndex).then(function () {
                ...
                this.I_StartDownloadRecord = function (e, t, n, r) {
                    ...
                    if (-1 != s) {
                        var i = I[s], a = {
                            szPlaybackURI: t, szFileName: n, bDateDir: !0
                        };
                ...
                this.I_StartDownloadRecordByTime = function (e, t, n, r, s, o) {
                    ...
                    if (-1 != i) {
                        var u = I[i], c = {
                            szPlaybackURI: t = t.split("?")[0] + "?starttime=" + r.replace(" ", "T") + "Z&endtime=" + s.replace(" ", "T") + "Z", szFileName: n, bDateDir: !0
                        };
                ...
                this.I_SendHTTPRequest = function (e, t, n) {
                    ...
                    if (!(r < 0)) {
                        var s = I[r], o = new K, i = {
                            type: "GET", url: s.szHttpProtocol + s.szIP + ":" + s.iCGIPort + "/" + t, auth: s.szAuth, success: null, error: null
                        };
                ...
                this.I_RemoteConfig = function (e, t) {
                    ...
                    if (Z())
                        return -1;
                    var s = {
                        iLan: 0, iDevicePort: -1, iType: 0
                    };
                    if (v.extend(s, t), -1 == n)
                        return -1;
                    var o = I[n];
                    if (-1 == s.iDevicePort) if (-1 == o.iDevicePort) {
                        if (o.iDevicePort = W(o).iDevicePort, -1 == (r = o.iDevicePort))
                            return -1
                    }
                    else r = o.iDevicePort;
                    else r = s.iDevicePort;
                    if (":" == v.Base64.decode(o.szAuth)[0]) var i = v.Base64.decode(o.szAuth).split(":")[1], a = v.Base64.decode(o.szAuth).split(":")[2];
                ...
                this.I2_SetSnapPolygonInfo = function (e, t) {
                    if (Z()) {
                        ...
                        for (nodeList = re.$XML(n).find("SnapPolygon", !0), i = 0, iLen = nodeList.length; i < iLen; i++) {
                            ...
                            r.push({
                                iPolygonType: 1, id: re.$XML(node).find("id").eq(0).text(), iEditType: 0, aPoint: o, bClosed: !0, szTips: re.$XML(node).find("tips").eq(0).text(), szDrawColor: s, iTranslucent: .1
                            })
                        }
                ...
                this.I_SetSnapPolygonInfo = function (e, t) {
                    if (Z()) {
                        ...
                        for (a = 0, u = (p = re.$XML(r).find("SnapPolygon", !0)).length; a < u; a++) {
                            ...
                            o = "#" + (o = V(o, 6)), s.push({
                                id: re.$XML(h).find("id").eq(0).text(), tips: re.$XML(h).find("tips").eq(0).text(), iMaxShapeSupport: n.length + 1, iMaxPointSupport: re.$XML(h).find("PointNumMax").eq(0).text(), iMinPointSupport: re.$XML(h).find("MinClosed").eq(0).text(), style: {
                                    szDrawColor: o, iTranslucent: .1
                                }
                            })
                        }
                        0 === p.length && s.push({
                            iMaxShapeSupport: 1, iMaxPointSupport: 17, iMinPointSupport: 1, style: {
                                szDrawColor: "#FFFF00", iTranslucent: .1
                            }
                        });
                        var i = [];
                ...
                this.I_GetTextOverlay = function (e, t, n) {
                    ...
                    if (-1 != r) {
                        var s = I[r], o = (m[r], {
                            async: !1, type: "GET", success: n.success, error: n.error
                        });
            ...
            var J = function () {
                ...
                K = function () {
                    this.options = {
                        type: "GET", url: "", auth: "", timeout: 1e4, data: "", async: !0, success: null, error: null
            ...
            K.prototype.m_httpRequestSet = [], K.prototype.setRequestParam = function (e) {
                ...
                K.prototype.submitRequest = function () {
                    ...
                    if (Z()) {
                        ...
                        s.setRequestHeader("X-Requested-With", "XMLHttpRequest"), s.setRequestHeader("If-Modified-Since", "0"), s.send(this.options.data || null);
                        var i = function () {
                            if (4 === s.readyState) {
                                t = {
                                    funSuccessCallback: n.options.success, funErrorCallback: n.options.error
                                };
                        ...
                        if (this.options.async) {
                            ...
                            -1 != u && (t = {
                                iRequestID: u, funSuccessCallback: this.options.success, funErrorCallback: this.options.error
                            ...
                            t = {
                                funSuccessCallback: this.options.success, funErrorCallback: this.options.error
            ...
            e.prototype.CGI = {
                login: "%s%s:%s/ISAPI/Security/userCheck", getAudioInfo: "%s%s:%s/ISAPI/System/TwoWayAudio/channels", getDeviceInfo: "%s%s:%s/ISAPI/System/deviceInfo", getAnalogChannelInfo: "%s%s:%s/ISAPI/System/Video/inputs/channels", getDigitalChannel: "%s%s:%s/ISAPI/ContentMgmt/InputProxy/channels", getDigitalChannelInfo: "%s%s:%s/ISAPI/ContentMgmt/InputProxy/channels/status", getZeroChannelInfo: "%s%s:%s/ISAPI/ContentMgmt/ZeroVideo/channels", getStreamChannels: {
                    analog: "%s%s:%s/ISAPI/Streaming/channels", digital: "%s%s:%s/ISAPI/ContentMgmt/StreamingProxy/channels"
                },
                getStreamDynChannels: "%s%s:%s/PSIA/Custom/SelfExt/ContentMgmt/DynStreaming/channels", startRealPlay: {
                    channels: "%s%s:%s/PSIA/streaming/channels/%s", zeroChannels: "%s%s:%s/PSIA/Custom/SelfExt/ContentMgmt/ZeroStreaming/channels/%s"
                },
                startShttpRealPlay: {
                    channels: "%s%s:%s/SDK/play/%s/004", zeroChannels: "%s%s:%s/SDK/play/100/004/ZeroStreaming"
                },
                startWsRealPlay: {
                    channels: "%s%s:%s/%s", zeroChannels: "%s%s:%s/%s"
                },
                startVoiceTalk: {
                    open: "%s%s:%s/ISAPI/System/TwoWayAudio/channels/%s/open", close: "%s%s:%s/ISAPI/System/TwoWayAudio/channels/%s/close", audioData: "%s%s:%s/ISAPI/System/TwoWayAudio/channels/%s/audioData"
                },
                ptzControl: {
                    analog: "%s%s:%s/ISAPI/PTZCtrl/channels/%s/continuous", digital: "%s%s:%s/ISAPI/ContentMgmt/PTZCtrlProxy/channels/%s/continuous"
                },
                ptzAutoControl: {
                    ipdome: "%s%s:%s/ISAPI/PTZCtrl/channels/%s/presets/%s/goto", analog: "%s%s:%s/ISAPI/PTZCtrl/channels/%s/autoPan", digital: "%s%s:%s/ISAPI/ContentMgmt/PTZCtrlProxy/channels/%s/autoPan"
                },
                setPreset: {
                    analog: "%s%s:%s/ISAPI/PTZCtrl/channels/%s/presets/%s", digital: "%s%s:%s/ISAPI/ContentMgmt/PTZCtrlProxy/channels/%s/presets/%s"
                },
                goPreset: {
                    analog: "%s%s:%s/ISAPI/PTZCtrl/channels/%s/presets/%s/goto", digital: "%s%s:%s/ISAPI/ContentMgmt/PTZCtrlProxy/channels/%s/presets/%s/goto"
                },
                ptzFocus: {
                    analog: "%s%s:%s/ISAPI/Image/channels/%s/focus", digital: "%s%s:%s/ISAPI/ContentMgmt/ImageProxy/channels/%s/focus", ipc: "%s%s:%s/ISAPI/System/Video/inputs/channels/%s/focus"
                },
                ptzIris: {
                    analog: "%s%s:%s/ISAPI/Image/channels/%s/iris", digital: "%s%s:%s/ISAPI/ContentMgmt/ImageProxy/channels/%s/iris", ipc: "%s%s:%s/ISAPI/System/Video/inputs/channels/%s/iris"
                },
                getNetworkBond: "%s%s:%s/ISAPI/System/Network/Bond", getNetworkInterface: "%s%s:%s/ISAPI/System/Network/interfaces", getUPnPPortStatus: "%s%s:%s/ISAPI/System/Network/UPnP/ports/status", getPPPoEStatus: "%s%s:%s/ISAPI/System/Network/PPPoE/1/status", getPortInfo: "%s%s:%s/ISAPI/Security/adminAccesses", recordSearch: "%s%s:%s/ISAPI/ContentMgmt/search", startPlayback: "%s%s:%s/PSIA/streaming/tracks/%s?starttime=%s&endtime=%s", startWsPlayback: "%s%s:%s/%s", startShttpPlayback: "%s%s:%s/SDK/playback/%s", startShttpReversePlayback: "%s%s:%s/SDK/playback/%s/reversePlay", startTransCodePlayback: "%s%s:%s/SDK/playback/%s/transcoding", startDownloadRecord: "%s%s:%s/ISAPI/ContentMgmt/download", downloaddeviceConfig: "%s%s:%s/ISAPI/System/configurationData", uploaddeviceConfig: "%s%s:%s/ISAPI/System/configurationData", restart: "%s%s:%s/ISAPI/System/reboot", restore: "%s%s:%s/ISAPI/System/factoryReset?mode=%s", startUpgrade: {
                    upgrade: "%s%s:%s/ISAPI/System/updateFirmware", status: "%s%s:%s/ISAPI/System/upgradeStatus"
                },
                set3DZoom: {
                    analog: "%s%s:%s/ISAPI/PTZCtrl/channels/%s/position3D", digital: "%s%s:%s/ISAPI/ContentMgmt/PTZCtrlProxy/channels/%s/position3D"
                },
                getSecurityVersion: "%s%s:%s/ISAPI/Security/capabilities?username=admin", SDKCapabilities: "%s%s:%s/SDK/capabilities", deviceCapture: {
                    channels: "%s%s:%s/ISAPI/Streaming/channels/%s/picture"
                },
                overlayInfo: {
                    analog: "%s%s:%s/ISAPI/System/Video/inputs/channels/%s/overlays/", digital: "%s%s:%s/ISAPI/ContentMgmt/InputProxy/channels/%s/video/overlays"
                },
                sessionCap: "%s%s:%s/ISAPI/Security/sessionLogin/capabilities?username=%s", sessionLogin: "%s%s:%s/ISAPI/Security/sessionLogin", sessionHeartbeat: "%s%s:%s/ISAPI/Security/sessionHeartbeat", sessionLogout: "%s%s:%s/ISAPI/Security/sessionLogout", systemCapabilities: "%s%s:%s/ISAPI/System/capabilities"
            },
                e.prototype.login = function (e, t, n, r) {
                    var s = 2 == r.protocol ? "https://" : "http://", o = b(this.CGI.login, s, e, t), i = new K, a = {
                        type: "GET", url: o, auth: n, success: null, error: null
                    };
                ...
                e.prototype.getAudioInfo = function (e, n) {
                    var t = b(this.CGI.getAudioInfo, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new K, s = {
                        type: "GET", url: t, auth: e.szAuth, success: null, error: null
                    };
                        ...
                        success: function (e) {
                            ...
                            for (var n = re.$XML(e).find("VideoInputChannel", !0), r = 0, s = n.length; r < s; r++) {
                                ...
                                t.push("<VideoInputChannel>"),
                                    t.push("<id>" + re.$XML(o).find("id").eq(0).text() + "</id>"),
                                    t.push("<inputPort>" + re.$XML(o).find("inputPort").eq(0).text() + "</inputPort>"),
                                    t.push("<name>" + v.escape(re.$XML(o).find("name").eq(0).text()) + "</name>"),
                                    t.push("<videoFormat>" + re.$XML(o).find("videoFormat").eq(0).text() + "</videoFormat>"),
                                    t.push("</VideoInputChannel>")
                            }
                ...
                e.prototype.getDigitalChannel = function (e, i) {
                    var t = b(this.CGI.getDigitalChannel, e.szHttpProtocol, e.szIP, e.iCGIPort),
                        n = new K,
                        r = {
                            type: "GET",
                            url: t,
                ...
                e.prototype.getStreamChannels = function (e, n) {
                    if (0 != e.iAnalogChannelNum) var t = b(this.CGI.getStreamChannels.analog, e.szHttpProtocol, e.szIP, e.iCGIPort);
                ...
                e.prototype.ptzAutoControl = function (s, e, o, i) {
                    ...
                    var r = new K, c = {
                        type: "PUT", url: a, async: !1, auth: s.szAuth, data: u, success: null, error: null
                    },
                        l = this;
                ...
                e.prototype.ptzControl = function (e, t, n, r) {
                    ...
                    switch (r.iPTZIndex) {
                        case 1: case 2: case 3: case 4: case 5: case 6: case 7: case 8: u = this.CGI.ptzControl, a = "<?xml version='1.0' encoding='UTF-8'?><PTZData><pan>" + i[r.iPTZIndex].pan + "</pan><tilt>" + i[r.iPTZIndex].tilt + "</tilt></PTZData>";
                            break;
                        case 10: case 11: u = this.CGI.ptzControl, a = "<?xml version='1.0' encoding='UTF-8'?><PTZData><zoom>" + i[r.iPTZIndex].speed + "</zoom></PTZData>";
                            break;
                        case 12: case 13: u = this.CGI.ptzFocus, a = "<?xml version='1.0' encoding='UTF-8'?><FocusData><focus>" + i[r.iPTZIndex].speed + "</focus></FocusData>";
                            break;
                        case 14: case 15: u = this.CGI.ptzIris, a = "<?xml version='1.0' encoding='UTF-8'?><IrisData><iris>" + i[r.iPTZIndex].speed + "</iris></IrisData>";
                            break;
                        default: return void (r.error && r.error())
                    ...
                    var c = new K, l = {
                        type: "PUT", url: o, async: !1, auth: e.szAuth, data: a, success: null, error: null
                    };
                ...
                e.prototype.setPreset = function (e, t, n) {
                    ...
                    var o = new K, i = {
                        type: "PUT", url: r, auth: e.szAuth, data: s, success: null, error: null
                    };
                    v.extend(i, n), v.extend(i, {
                        success: function (e) {
                            n.success && n.success(e)
                ...
                e.prototype.goPreset = function (e, t, n) {
                    ...
                    var s = new K, o = {
                        type: "PUT", url: r, auth: e.szAuth, success: null, error: null
                    };
                ...
                e.prototype.recordSearch = function (e, i) {
                    ...
                    var u = new K, c = {
                        type: "POST", url: t, auth: e.szAuth, data: n, success: null, error: null
                    };
                    v.extend(c, i), v.extend(c, {
                        success: function (e) {
                            var t = [];
                ...
                e.prototype.startPlayback = function (t, n) {
                    ...
                    if ("rtsp://" === n.urlProtocol && (i = A(i)), Z()) if (p.proxyAddress) {
                    ...
                    if (!M(n.oTransCodeParam)) {
                        var u = function (e) {
                            var t = {
                                TransFrameRate: "", TransResolution: "", TransBitrate: ""
                            };
                ...
                e.prototype.importDeviceConfig = function (e, t, n) {
                    ...
                    if (Z()) {
                        var s = {
                            type: "PUT", url: r, auth: e.szAuth, success: function () {
                            },
                            error: function () {
                            }
                        },
                ...
                e.prototype.restart = function (e, n) {
                    var t = b(this.CGI.restart, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new K, s = {
                        type: "PUT", url: t, auth: e.szAuth, success: null, error: null
                    };
                    v.extend(s, n), v.extend(s, {
                        success: function (e) {
                            n.success && n.success(e)
                ...
                e.prototype.asyncstartUpgrade = function (e, t) {
                    ...
                    if (Z())
                        r = B(r), s = B(s), y.JS_StartUpgradeEx(r, s).then(function (e) {
                            n.resolve(e)
                        },
                            function () {
                                n.reject(o)
                ...
                e.prototype.set3DZoom = function (e, t, n, r) {
                    ...
                    var l = "<?xml version='1.0' encoding='UTF-8'?><Position3D><StartPoint><positionX>" + i + "</positionX><positionY>" + (255 - a) + "</positionY></StartPoint><EndPoint><positionX>" + u + "</positionX><positionY>" + (255 - c) + "</positionY></EndPoint></Position3D>", d = new K, p = {
                        type: "PUT", url: s, data: l, auth: e.szAuth, success: null, error: null
                    };
                ...
                e.prototype.getSDKCapa = function (e, n) {
                    var t = b(this.CGI.SDKCapabilities, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new K, s = {
                        type: "GET", url: t, async: !1, auth: e.szAuth, success: null, error: null
                    };
                    v.extend(s, n), v.extend(s, {
                        success: function (e) {
                            n.success && n.success(e)
                ...
                e.prototype.getSessionV2Cap = function (e, t, n, r, s, o) {
                    ...
                    a = a + "&random:" + e;
                    var u = new K, c = {
                        type: "GET", url: a, auth: "", success: null, error: null
                    };
                ...
                e.prototype.getSessionCap = function (e, t, n, r, s) {
                    ...
                    var i = b(this.CGI.sessionCap, o, e, n, encodeURIComponent(r)), a = new K, u = {
                        type: "GET", url: i, auth: "", success: null, error: null
                    };
                ...
                e.prototype.sessionV2Login = function (e, t, n, r, s, o, i, a) {
                    ...
                    0 < re.$XML(i).find("isIrreversible", !0).length && (P = "true" === re.$XML(i).find("isIrreversible").eq(0).text(), I = re.$XML(i).find("salt").eq(0).text()), this.m_oInfoForLocalPlgin = {
                        szRandom: e, sessionID: p, iterations: f, challenge: h, user: s
                    };
                    var m = v.encodePwd(o, {
                        challenge: h, userName: s, salt: I, iIterate: f
                    }, P), S = "<SessionLogin>";
                    ...
                    var C = new K, y = {
                        type: "POST", url: d, data: S, auth: "", success: null, error: null
                    };
                ...
                e.prototype.sessionLogin = function (e, t, n, r, s, o, i) {
                    ...
                    var m = new K, S = {
                        type: "POST", url: u, data: I, auth: "", success: null, error: null
                    };
            ...
            n.prototype.CGI = {
                login: "%s%s:%s/PSIA/Custom/SelfExt/userCheck", getAudioInfo: "%s%s:%s/PSIA/Custom/SelfExt/TwoWayAudio/channels", getDeviceInfo: "%s%s:%s/PSIA/System/deviceInfo", getAnalogChannelInfo: "%s%s:%s/PSIA/System/Video/inputs/channels", getDigitalChannel: "%s%s:%s/PSIA/Custom/SelfExt/ContentMgmt/DynVideo/inputs/channels", getDigitalChannelInfo: "%s%s:%s/PSIA/Custom/SelfExt/ContentMgmt/DynVideo/inputs/channels/status", getZeroChannelInfo: "%s%s:%s/PSIA/Custom/SelfExt/ContentMgmt/ZeroVideo/channels", getStreamChannels: {
                    analog: "%s%s:%s/PSIA/Streaming/channels", digital: "%s%s:%s/PSIA/Custom/SelfExt/ContentMgmt/DynStreaming/channels"
                },
                getStreamDynChannels: "%s%s:%s/PSIA/Custom/SelfExt/ContentMgmt/DynStreaming/channels", startRealPlay: {
                    channels: "%s%s:%s/PSIA/streaming/channels/%s", zeroChannels: "%s%s:%s/PSIA/Custom/SelfExt/ContentMgmt/ZeroStreaming/channels/%s"
                },
                startVoiceTalk: {
                    open: "%s%s:%s/PSIA/Custom/SelfExt/TwoWayAudio/channels/%s/open", close: "%s%s:%s/PSIA/Custom/SelfExt/TwoWayAudio/channels/%s/close", audioData: "%s%s:%s/PSIA/Custom/SelfExt/TwoWayAudio/channels/%s/audioData"
                },
                ptzControl: "%s%s:%s/PSIA/PTZ/channels/%s/continuous", ptzAutoControl: "%s%s:%s/PSIA/Custom/SelfExt/PTZ/channels/%s/autoptz", setPreset: "%s%s:%s/PSIA/PTZ/channels/%s/presets/%s", goPreset: "%s%s:%s/PSIA/PTZ/channels/%s/presets/%s/goto", ptzFocus: "%s%s:%s/PSIA/System/Video/inputs/channels/%s/focus", ptzIris: "%s%s:%s/PSIA/System/Video/inputs/channels/%s/iris", getNetworkBond: "%s%s:%s/PSIA/Custom/SelfExt/Bond", getNetworkInterface: "%s%s:%s/PSIA/System/Network/interfaces", getUPnPPortStatus: "%s%s:%s/PSIA/Custom/SelfExt/UPnP/ports/status", getPPPoEStatus: "%s%s:%s/PSIA/Custom/SelfExt/PPPoE/1/status", getPortInfo: "%s%s:%s/PSIA/Security/AAA/adminAccesses", recordSearch: "%s%s:%s/PSIA/ContentMgmt/search", startPlayback: "%s%s:%s/PSIA/streaming/tracks/%s?starttime=%s&endtime=%s", startDownloadRecord: "%s%s:%s/PSIA/Custom/SelfExt/ContentMgmt/download", deviceConfig: "%s%s:%s/PSIA/System/configurationData", restart: "%s%s:%s/PSIA/System/reboot", restore: "%s%s:%s/PSIA/System/factoryReset?mode=%s", startUpgrade: {
                    upgrade: "%s%s:%s/PSIA/System/updateFirmware", status: "%s%s:%s/PSIA/Custom/SelfExt/upgradeStatus"
                },
                set3DZoom: "%s%s:%s/PSIA/Custom/SelfExt/PTZ/channels/%s/Set3DZoom", deviceCapture: {
                ...
                n.prototype.getDeviceInfo = function (e, n) {
                    ...
                    v.extend(s, n), v.extend(s, {
                        success: function (e) {
                            var t = [];
                            t.push("<DeviceInfo>"), t.push("<deviceName>" + v.escape(re.$XML(e).find("deviceName").eq(0).text()) + "</deviceName>"), t.push("<deviceID>" + re.$XML(e).find("deviceID").eq(0).text() + "</deviceID>"), t.push("<deviceType>" + re.$XML(e).find("deviceDescription").eq(0).text() + "</deviceType>"), t.push("<model>" + re.$XML(e).find("model").eq(0).text() + "</model>"), t.push("<serialNumber>" + re.$XML(e).find("serialNumber").eq(0).text() + "</serialNumber>"), t.push("<macAddress>" + re.$XML(e).find("macAddress").eq(0).text() + "</macAddress>"), t.push("<firmwareVersion>" + re.$XML(e).find("firmwareVersion").eq(0).text() + "</firmwareVersion>"), t.push("<firmwareReleasedDate>" + re.$XML(e).find("firmwareReleasedDate").eq(0).text() + "</firmwareReleasedDate>"), t.push("<encoderVersion>" + re.$XML(e).find("logicVersion").eq(0).text() + "</encoderVersion>"), t.push("<encoderReleasedDate>" + re.$XML(e).find("logicReleasedDate").eq(0).text() + "</encoderReleasedDate>"), t.push("</DeviceInfo>"), e = v.loadXML(t.join("")), n.success && n.success(e)
                        },
                        error: function (e, t) {
                            n.error && n.error(e, t)
                        }
                ...
                n.prototype.getSystemCapa = function (e, n) {
                    var t = b(this.CGI.systemCapabilities, e.szHttpProtocol, e.szIP, e.iCGIPort), r = new K, s = {
                        type: "GET", async: !1, url: t, auth: e.szAuth, success: null, error: null
                    };
                    v.extend(s, n), v.extend(s, {
                        success: function (e) {
                            n.success && n.success(e)
                        ...
                        v.extend(r, a), v.extend(r, {
                            success: function (e) {
                                ...
                                for (var n = re.$XML(e).find("DynVideoInputChannelStatus", !0), r = 0, s = n.length; r < s; r++) {
                                    var o = n[r], i = re.$XML(o).find("id").eq(0).text();
                                    t.push("<InputProxyChannelStatus>"), t.push("<id>" + i + "</id>"), t.push("<sourceInputPortDescriptor>"), t.push("<proxyProtocol>" + re.$XML(o).find("adminProtocol").eq(0).text() + "</proxyProtocol>"), t.push("<addressingFormatType>" + re.$XML(o).find("addressingFormatType").eq(0).text() + "</addressingFormatType>"), t.push("<ipAddress>" + re.$XML(o).find("ipAddress").eq(0).text() + "</ipAddress>"), t.push("<managePortNo>" + re.$XML(o).find("adminPortNo").eq(0).text() + "</managePortNo>"), t.push("<srcInputPort>" + re.$XML(o).find("srcInputPort").eq(0).text() + "</srcInputPort>"), t.push("<userName>" + v.escape(re.$XML(o).find("userName").eq(0).text()) + "</userName>"), t.push("<streamType>" + re.$XML(o).find("streamType").eq(0).text() + "</streamType>"), t.push("<online>" + re.$XML(o).find("online").eq(0).text() + "</online>"), t.push("<name>" + v.escape(c[i]) + "</name>"), t.push("</sourceInputPortDescriptor>"), t.push("</InputProxyChannelStatus>")
                                }
                                t.push("</InputProxyChannelStatusList>"), e = v.loadXML(t.join("")), a.success && a.success(e)
                            },
                            error: function (e, t) {
                ...
                n.prototype.getPortInfo = function (o, i) {
                    var e = b(this.CGI.getPortInfo, o.szHttpProtocol, o.szIP, o.iCGIPort), t = new K, n = {
                        type: "GET", url: e, auth: o.szAuth, success: null, error: null
                    };
                ...
                n.prototype.ptzControl = function (e, t, n, r) {
                    ...
                    var u = new K, c = {
                        type: "PUT", url: s, async: !1, auth: e.szAuth, data: i, success: null, error: null
                    };
                ...
                n.prototype.set3DZoom = function (e, t, n, r) {
                    var s = b(this.CGI.set3DZoom, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID), o = new K, i = {
                        type: "PUT", url: s, data: n, auth: e.szAuth, success: null, error: null
                    };
            ...
            ee.prototype.extend = function () {
                ...
                ee.prototype.encodeAES = function (e, t, n, r) {
                    ...
                    if ("ecb" === r)
                        ...
                        s = CryptoJS.AES.encrypt(e, a, {
                            mode: CryptoJS.mode.CBC, iv: u, padding: CryptoJS.pad.Pkcs7
                        }).ciphertext.toString()
                    }
                    return s
                },
                ee.prototype.sha256 = function (e) {
                    ...
                    return function (e) {
                        ...
                        var n, r, s, o, i, a, u, c, l, d, p, h, f = [1116352408, 1899447441, 3049323471, 3921009573, 961987163, 1508970993, 2453635748, 2870763221, 3624381080, 310598401, 607225278, 1426881987, 1925078388, 2162078206, 2614888103, 3248222580, 3835390401, 4022224774, 264347078, 604807628, 770255983, 1249150122, 1555081692, 1996064986, 2554220882, 2821834349, 2952996808, 3210313671, 3336571891, 3584528711, 113926993, 338241895, 666307205, 773529912, 1294757372, 1396182291, 1695183700, 1986661051, 2177026350, 2456956037, 2730485921, 2820302411, 3259730800, 3345764771, 3516065817, 3600352804, 4094571909, 275423344, 430227734, 506948616, 659060556, 883997877, 958139571, 1322822218, 1537002063, 1747873779, 1955562222, 2024104815, 2227730452, 2361852424, 2428436474, 2756734187, 3204031479, 3329325298], P = [1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225], I = Array(64);
                        for (e[t >> 5] |= 128 << 24 - t % 32, e[15 + (t + 64 >> 9 << 4)] = t, l = 0; l < e.length; l += 16) {
                            for (n = P[0], r = P[1], s = P[2], o = P[3], i = P[4], a = P[5], u = P[6], c = P[7], d = 0; d < 64; d++)
                ...
                te.getIntegerBits = function (e, t, n) {
                    ...
                    for (i = Math.floor(t / 4); i <= Math.floor(n / 4); i++)
                        s[i] && "" != s[i] ? o += s[i] : o += "0";
                    return o
                },
