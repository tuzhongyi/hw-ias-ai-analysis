import { GisPointMatchResult } from '../../../data-core/models/arm/geographic/patrol/gis-point-match-result.model';

export class GisPointMatchResultTool {
  split(arr: GisPointMatchResult[]) {
