...
@Component({
  selector: 'ias-management-iframe',
  imports: [],
  templateUrl: './management-iframe.component.html',
  styleUrl: './management-iframe.component.less',
})
export class ManagementIframeComponent implements OnInit, OnDestroy {
  constructor(
