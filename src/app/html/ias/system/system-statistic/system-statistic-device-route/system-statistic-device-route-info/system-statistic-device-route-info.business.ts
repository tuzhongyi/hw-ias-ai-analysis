...
// @Injectable()
// export class SystemStatisticDeviceRouteInfoBusiness {
//   constructor(private route:) {}

//   async load(args: SystemStatisticDeviceRouteArgs) {
...
//     let info: ISystemStatisticDeviceRouteInfo = {
...
//   private data = {
//     load: async (args: SystemStatisticDeviceRouteArgs) => {
