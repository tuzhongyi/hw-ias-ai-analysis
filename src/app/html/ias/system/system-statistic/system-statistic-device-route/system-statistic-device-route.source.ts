...
import { SystemModuleMobileDeviceRouteType } from '../../system-module/system-module-mobile-device-route/system-module-mobile-device-route.model';

@Injectable()
export class SystemStatisticDeviceRouteSource {
