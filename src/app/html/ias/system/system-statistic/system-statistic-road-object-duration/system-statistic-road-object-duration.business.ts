...
@Injectable()
export class SystemStatisticRoadObjectDurationBusiness {
  constructor(
  ...
  async record(args: SystemStatisticRoadObjectDurationArgs) {
  ...
  private data = {
    record: (args: SystemStatisticRoadObjectDurationArgs) => {
