...
import { SystemModuleRoadSectionMapAMapCreatorCircleController } from './system-module-road-section-map-amap-creator-circle.controller';
import { SystemModuleRoadSectionMapAMapCreatorPolylineController } from './system-module-road-section-map-amap-creator-polyline.controller';

export class SystemModuleRoadSectionMapAMapCreatorController {
  create = new EventEmitter<[number, number][]>();

  constructor(private map: AMap.Map) {
    this.polyline = new SystemModuleRoadSectionMapAMapCreatorPolylineController(
      map
    );
    this.circle = new SystemModuleRoadSectionMapAMapCreatorCircleController(
      map
    );
  ...
  private polyline: SystemModuleRoadSectionMapAMapCreatorPolylineController;
  private circle: SystemModuleRoadSectionMapAMapCreatorCircleController;
