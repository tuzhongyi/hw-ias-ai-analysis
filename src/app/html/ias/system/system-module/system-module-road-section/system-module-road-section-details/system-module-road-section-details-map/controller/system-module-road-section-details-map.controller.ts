...
import { SystemModuleRoadSectionDetailsMapAMapController } from './amap/system-module-road-section-details-map-amap.controller';
import { SystemModuleRoadSectionDetailsMapPositionController } from './system-module-road-section-details-map-position.controller';

@Injectable()
export class SystemModuleRoadSectionDetailsMapController {
  constructor(
    public amap: SystemModuleRoadSectionDetailsMapAMapController,
    public position: SystemModuleRoadSectionDetailsMapPositionController
  ) {
    this.regist();
  }
