...
@Component({
  selector: 'ias-system-module-road-object-video-map-position',
  imports: [CommonModule, FormsModule],
  templateUrl: './system-module-road-object-video-map-position.component.html',
  styleUrl: './system-module-road-object-video-map-position.component.less',
})
export class SystemModuleRoadObjectVideoMapPositionComponent
