...
@Component({
  selector: 'ias-system-module-shop-compare-table-existed',
  imports: [CommonModule, PaginatorComponent],
  templateUrl: './system-module-shop-compare-table-existed.component.html',
  styleUrl: './system-module-shop-compare-table-existed.component.less',
  providers: [SystemModuleShopCompareTablePagedBusiness],
})
export class SystemModuleShopCompareTableExistedComponent implements OnChanges {
  @Input('datas') shops: Array<IShop> = [];
  @Output() info = new EventEmitter<IShop>();
  @Output() compare = new EventEmitter<IShop>();
  ...
  oncompare(item: IShop, e: Event) {
    this.compare.emit(item);
    e.stopPropagation();
  }
}
