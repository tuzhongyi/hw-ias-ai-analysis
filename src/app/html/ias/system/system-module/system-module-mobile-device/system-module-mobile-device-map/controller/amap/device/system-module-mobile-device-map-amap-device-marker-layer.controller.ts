...
import { SystemModuleMobileDeviceMapAMapDeviceMarkerController } from './system-module-mobile-device-map-amap-device-marker.controller';
...
export class SystemModuleMobileDeviceMapAMapDeviceMarkerLayerController {
  ...
  private points: SystemModuleMobileDeviceMapAMapDeviceMarkerController[] = [];
  ...
  private regist(point: SystemModuleMobileDeviceMapAMapDeviceMarkerController) {
