...
@Component({
  selector: 'ias-system-event-process-info-handled',
  imports: [CommonModule],
  templateUrl: './system-event-process-info-handled.component.html',
  styleUrl: './system-event-process-info-handled.component.less',
})
export class SystemEventProcessInfoHandledComponent {
