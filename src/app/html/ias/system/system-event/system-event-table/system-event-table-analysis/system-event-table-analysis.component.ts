...
@Component({
  selector: 'ias-system-event-table-analysis',
  imports: [CommonModule, PaginatorComponent],
  templateUrl: './system-event-table-analysis.component.html',
  styleUrl: './system-event-table-analysis.component.less',
  providers: [SystemEventTableService, SystemEventTableBusiness],
})
export class SystemEventTableAnalysisComponent implements OnInit, OnDestroy {
