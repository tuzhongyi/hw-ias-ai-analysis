...
import { SystemTaskFileDetailsMapManagerComponent } from '../../../../system-task/system-task-shop/system-task-file/system-task-file-details-map-manager/system-task-file-details-map-manager.component';
