declare namespace AMap {
  /** MapOptions **/
  interface MapOptions extends Map3DOptions {
  ...
  class Map extends Map3D {
    ...
    setFitView(overlayList?: Array<any> | null, immediately?: boolean): void
    ...
    plugin(name: string | Array<any>, callback: () => {}): void
    ...
    setMask(path: number[] | number[][]): void
  }
  /** View2DOptions **/
